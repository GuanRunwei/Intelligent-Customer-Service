...
tf.flags.DEFINE_string('train_file', os.path.join(os.path.dirname(os.getcwd()), "\\data\\valid\\final_regroup.csv"), 'train raw file')
tf.flags.DEFINE_string('test_file', os.path.join(os.path.dirname(os.getcwd()), "\\data\\valid\\final_test.csv"), 'test raw file')
tf.flags.DEFINE_string('standard_file', os.path.join(os.path.dirname(os.getcwd()), "\\data\\valid\\standard.csv"), 'standard raw file')
